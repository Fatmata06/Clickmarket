...
export const metadata: Metadata = {
  ...
  description: 'Découvrez notre histoire, notre mission et notre engagement pour des produits frais et locaux.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Notre <span className="text-green-600 dark:text-green-400">Histoire</span>
          </h1>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            ClickMarket est né d&apos;une passion pour les produits frais et d&apos;un désir de reconnecter les consommateurs 
            avec les producteurs locaux. Notre mission : rendre accessible à tous des fruits et légumes de qualité.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <div className="space-y-4 text-gray-600 dark:text-gray-300">
              <p>
                Fondé en 2020 à Dakar, ClickMarket a commencé comme un petit projet familial avec une simple idée : 
                fournir des produits frais directement des champs aux tables des familles sénégalaises.
              </p>
              <p>
                Aujourd&apos;hui, nous collaborons avec plus de 50 producteurs locaux et livrons dans 4 zones différentes, 
                tout en restant fidèles à nos valeurs initiales.
              </p>
              <p>
                Notre croissance est le résultat de la confiance que nos clients nous accordent et de notre engagement 
                inébranlable envers la qualité.
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">Producteurs locaux</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">Livraison moyenne</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-2 sm:-right-6 bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-2xl shadow-xl dark:shadow-gray-900/50 w-64">
              <div className="flex items-center gap-3 mb-3">
                <Award className="h-8 w-8 text-yellow-500" />
                <div>
                  <div className="font-bold text-gray-900 dark:text-white">Prix 2023</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Meilleure startup agro</div>
                </div>
              </div>
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-12">
            Nos <span className="text-green-600 dark:text-green-400">Valeurs</span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <Card key={index} className="border-0 shadow-lg dark:shadow-gray-900/50 dark:bg-gray-800">
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-white mb-12">
            Notre <span className="text-green-600 dark:text-green-400">Équipe</span>
          </h2>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-green-600 to-emerald-500 dark:from-green-700 dark:to-emerald-600 rounded-2xl p-8 md:p-12 text-center text-white">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">
            Prêt à découvrir la différence ClickMarket ?
          </h2>
          <p className="mb-6 text-green-100 dark:text-green-200 max-w-2xl mx-auto">
            Rejoignez des milliers de clients satisfaits qui ont choisi la fraîcheur et la qualité
          </p>
