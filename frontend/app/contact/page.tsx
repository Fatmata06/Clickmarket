      ...
      <div className="page-container">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
            Contactez-
            <span className="text-green-600 dark:text-green-400">nous</span>
          </h1>
            ...
            <div className="mt-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <Card key={index} className="shadow dark:shadow-gray-900/50">
          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-lg dark:shadow-gray-900/50">
              <CardContent className="p-6">
                ...
                <Button className="w-full gap-2 btn-destructive">
